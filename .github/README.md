...
[`@aws-sdk/dsql-signer`](https://www.npmjs.com/package/@aws-sdk/dsql-signer/v/3.705.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/dsql-signer@3.705.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/dsql-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/dsql-signer@3.705.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/dsql-signer@3.705.0/index.min.mjs": "sha384-emzMt7q1d74A71C5EQoI+NjPLnT82iy9V9DdTRdMUYxo+wOwcNb7xQ8qh88CF3/q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/dsql-signer/blob/refs/tags/3.705.0/LICENSE
```
