...
[`@aws-sdk/dsql-signer`](https://www.npmjs.com/package/@aws-sdk/dsql-signer/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/dsql-signer@3.738.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/dsql-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/dsql-signer@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/dsql-signer@3.738.0/index.min.mjs": "sha384-7YRpb0DOpx41+XvALyD+HTIFmoYBqzK27CbqJvIqJOrdZTz5FNrlPbQdE5hm5aDK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/dsql-signer/blob/refs/tags/3.738.0/LICENSE
```
